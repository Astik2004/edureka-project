...
app.post('/form.html', function (req, res) {
    ...
    const transporter = nodemailer.createTransport({
        service: 'gmail',
        auth: {
            user: 'yadavastik2004@gmail.com',
            pass: 'rllqpkstuoejbugo'
        }
    })

    var mailoptions = {
        from: 'yadavastik2004@gmail.com.com',
        to: req.body.email,
        subject: 'Welcome to edukart ' ,
        html: "Welcome to edukart! <br> Good to have you here.<br> Is there any way we could make your journey easier? <br> Edureka!! <br> Leader:- Er.Astik Yadav <br> feel free to ask your questions <br> We will reply As soon as possible <br> THANKYOU!!"
